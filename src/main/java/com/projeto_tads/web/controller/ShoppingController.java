...
import com.projeto_tads.web.service.ShoppingService;
...
public class ShoppingController {
  ...
  public String deleteShopping(@PathVariable("id") UUID id)
  {
...
// para chamar a pagina de edit-student.html
 @GetMapping("/edit/{id}")
 public String editShopping (@PathVariable("id") UUID id, Model model){
 ...
 @PostMapping("/update/{id}")
    public String updateShopping(@PathVariable("id") UUID id, @ModelAttribute Shopping shopping){
        shoppingService.save(shopping);
